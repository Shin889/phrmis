    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pastfromdate', models.DateField(blank=True, null=True)),
                ('pasttodate', models.DateField(blank=True, null=True)),
                ('employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='work_experiences', to='HRMIS.personalinformation')),
            ],
        ),
    ]
